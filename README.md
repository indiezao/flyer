...
```
Antes de utilizar, o arquivo template deve ser modificado para garantir o funcionamento
correto do script.
...
1. Alterar as informações do arquivo ofertas.txt:
   ...
   a formatação deve seguir o seguinte padrão:
      <nome do produto> <unidade (kg, und, lt)> <preço>

2. Execute o script app_ofertas.py
   o script deve, automaticamente, preencher os campos de texto com as informações
      corretas da lista.
   a imagem será puxada da pasta /fotos/ e deve conter o exato mesmo nome do produto.
   caso o app não encontre uma imagem correspondente ao do produto, continuará normalmente
      até o fim do loop.
